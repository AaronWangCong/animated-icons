...
.saudi-riyal-icon svg.animating path, .saudi-riyal-icon svg.animating circle, .saudi-riyal-icon svg.animating line, .saudi-riyal-icon svg.animating polyline { animation: icon-anim 0.4s ease-in-out forwards; }
