...
.flame-icon svg.animating path, .flame-icon svg.animating circle, .flame-icon svg.animating line, .flame-icon svg.animating polyline { animation: icon-anim 0.4s ease-in-out forwards; }
