...
.party-popper-icon svg.animating path, .party-popper-icon svg.animating circle, .party-popper-icon svg.animating line, .party-popper-icon svg.animating polyline { animation: icon-anim 0.7s ease-in-out forwards; }
